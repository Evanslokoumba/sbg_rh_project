...
<div class="row g-3 mb-3">
    ...
    <div class="card h-md-100">
        ...
        <div class="row h-100 justify-content-between g-0">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-1100 fs-2">26M</div>
            </div>
        </div>
        </div>
    </div>
...
<div class="row g-0">
    ...
    <div class="card h-lg-100 overflow-hidden">
        ...
        <div class="card-footer bg-body-tertiary p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="#!">Show all projects<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
    </div>
    </div>
