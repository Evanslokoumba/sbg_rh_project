...
@section('bodycontent')
    ...
    <h2>Page toutes mes demandes</h2>
    <div class="card mb-3 mb-lg-0">
        <div class="card-header bg-body-tertiary d-flex justify-content-between">
            <h5 class="mb-0">Historiques des demandes</h5>
            <form>
                ...
                <div class="col-md-6 h-100">
                    <div class="d-flex btn-reveal-trigger">
                        ...
                        <div class="flex-1 position-relative ps-3">
                            <h6 class="fs-0 mb-0"><a href="../../app/events/event-detail.html">Crain's New York Business <span class="badge badge-subtle-success rounded-pill">Free</span></a></h6>
